"""KA-level adapters for GraphML, CSV, and JSON-LD export.

CLI ``he export graphml/csv/jsonld`` and MCP ``export_graphml`` /
``export_csv`` / ``export_jsonld`` call these functions so extractor
