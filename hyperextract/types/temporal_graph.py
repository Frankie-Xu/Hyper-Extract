...
class AutoTemporalGraph(AutoGraph[NodeSchema, EdgeSchema]):
    ...
    # ==============================================================================
    # Override Extraction Payloads to Dynamically Inject Observation Date
    # ==============================================================================

    def _one_stage_payload(self, chunk: str) -> dict[str, Any]:
        """Inject observation_time into one-stage extraction."""
        return {"source_text": chunk, "observation_time": self.observation_time}

    def _edge_payload(self, chunk: str, known_nodes: str) -> dict[str, Any]:
        """Inject observation_time into two-stage edge extraction."""
        return {
            "source_text": chunk,
